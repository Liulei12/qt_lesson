...
/* 登录框会从上至下出来 */
.login_dialog_transition-enter-active,
.login_dialog_transition-leave-active {
  transition: all 0.3s ease-out;
}
.login_dialog_transition-enter,
.login_dialog_transition-leave-to {
  transform: translate(0, -35%);
  opacity: 0.3;
}
.login_dialog_transition-enter-to,
.login_dialog_transition-leave {
